            ...
            <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginBottom: 28 }}>
                {[
                  ...
                  { label: "🟡 In allerta", val: teamStats.reduce((s, t) => s + t.alert2.length, 0), color: "#eab308" },
              ...
              <div className="card" style={{ padding: 0, overflow: "hidden" }}>
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead>
                    <tr style={{ background: "#111118", borderBottom: "2px solid #21212e" }}>
                      {["Team", "Roster", "Posti liberi", "🟡 Allerta", "Presenze medie/evento", "Punteggio medio"].map(h => (
                  ...
                  <tbody>
                    {teamStats.map(({ team, teamPlayers, freeSlots, alert2, mediaPresenze, mediaPunteggio }, i) => (
                      <tr key={team.id} className="tr" style={{ borderBottom: "1px solid #1c1c28" }}>
                        ...
                        <td style={{ padding: "12px 14px", textAlign: "center", fontWeight: 700 }}>
                          {alert2.length > 0
                            ? <span style={{ color: "#eab308" }}>⚠️ {alert2.length}</span>
                    ...
                    {data.teams.length === 0 && (
                      <tr><td colSpan={6} style={{ padding: 40, textAlign: "center", color: "#444" }}>Nessun team ancora.</td></tr>
                    )}
                  </tbody>
                </table>
              </div>
